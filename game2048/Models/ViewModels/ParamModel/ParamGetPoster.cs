...
{
  public  class ParamGetPoster:ParamUserBase,IValidatableObject
    {
        ...
        {
            ParamGetPoster result = null;
            try
            {
                result = SecurityHelper.GetAES<ParamGetPoster>(this.Sign, SignKey);
            }
            catch
            {
                result = new ParamGetPoster();
            }
